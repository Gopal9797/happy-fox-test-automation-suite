package testFiles.CommonTests;

import org.testng.Assert;
import pageObjects.Admin_Portal.AdminPortalTest1stPage;
import pageObjects.Admin_Portal.AdminPortalTest2ndPage;
import pageObjects.Admin_Portal.LoginPage;
import pageObjects.CustomerPortal.SupportPortalPage;
...
public class CommonTests1 extends BaseTest {
    ...
    public void loginasAdmin() {
        ...
        try {
            ...
            hpAdminPortalTest1 = hploginpage.validatePendingTicketsTitle1();
        } catch (Throwable t) {
            t.printStackTrace();
    ...
    public void TestCase2() {
        ...
        try {
            ...
            hploginpage.validatePendingTicketsTitle();
